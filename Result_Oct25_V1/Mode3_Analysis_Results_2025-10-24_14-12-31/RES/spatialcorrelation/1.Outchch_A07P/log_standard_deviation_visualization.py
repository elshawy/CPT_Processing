...
# CSV 로드
input_file = 'Mode3_combined_results.csv'
...
plt.plot(df.index, log_errors, marker='o', linestyle='-', color='b', label='(ln(Measured) - ln(Predicted)')
plt.axhline(0, color='r', linestyle='--', label='Zero Error Line')
plt.title('Log Residuals (ln(Measured) - ln(Predicted))')
plt.xlabel('Index')
